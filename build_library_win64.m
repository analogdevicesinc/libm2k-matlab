...
if ispc
    includepath = fullfile(pwd,'libm2k-win64');
    hppPath = fullfile(pwd,'libm2k-win64','libm2k');
    libs = fullfile(pwd,'libm2k-win64','libm2k.lib');
    myPkg = 'libm2k';
else
...
h1 = fullfile(pwd,'libm2k-win64','iio.h');  h = [{h1},h(:)'];
headers = h;
