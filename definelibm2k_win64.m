...
defineOutput(getSamplesPDefinition, "RetVal", "clib.array.libm2k.UnsignedShort", "nb_samples", "Description", "A pointer to the data"); % '<MLTYPE>' can be clib.array.libm2k.UnsignedShort, or uint16
