%% About definelibm2k_ml.mlx
% This file defines the MATLAB interface to the library |libm2k_ml|.
%
...
DMMDefinition = addClass(libDef, "libm2k::analog::DMM", "MATLABName", "clib.libm2k.libm2k.analog.DMM", ...
    "Description", "clib.libm2k.libm2k.analog.DMM    Representation of C++ class libm2k::analog::DMM."); % Modify help description values as needed.
...
%    "DetailedDescription", "This content is from the external library documentation."); % Modify help description values as needed.
%defineOutput(getTriggerDefinition, "RetVal", "clib.libm2k.libm2k.M2kHardwareTrigger", <SHAPE>, "Description", "A pointer to the hardware trigger trigger"); % '<MLTYPE>' can be clib.libm2k.libm2k.M2kHardwareTrigger, or clib.array.libm2k.libm2k.M2kHardwareTrigger
...
% C++ Signature: static std::vector<libm2k::utils::ini_device_struct, std::allocator<libm2k::utils::ini_device_struct>> libm2k::utils::Utils::parseIniFile(std::string path)
% parseIniFileDefinition = addMethod(UtilsDefinition, ...
%     "static std::vector<libm2k::utils::ini_device_struct, std::allocator<libm2k::utils::ini_device_struct>> libm2k::utils::Utils::parseIniFile(std::string path)", ...
...
% C++ Signature: static std::vector<double, std::allocator<double>> libm2k::utils::Utils::getAvailableSamplerates(iio_device * input1)
%getAvailableSampleratesDefinition = addMethod(UtilsDefinition, ...
%    "static std::vector<double, std::allocator<double>> libm2k::utils::Utils::getAvailableSamplerates(iio_device * input1)", ...
