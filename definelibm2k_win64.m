...
libDef = clibgen.LibraryDefinition("libm2kData_win64.xml");
%% OutputFolder and Libraries 
libDef.OutputFolder = pwd;
libDef.Libraries = fullfile(pwd,"libm2k-win64","libm2k.lib");
...
%defineOutput(iio_channel_get_indexDefinition, "RetVal", "int32");
...
defineArgument(pushInterleavedDefinition, "data", "double", "input", "nb_samples");
defineArgument(pushInterleavedDefinition, "nb_channels", "uint32");
defineArgument(pushInterleavedDefinition, "nb_samples", "uint32");
...
defineArgument(pushRawInterleavedDefinition, "data", "int16", "input", "nb_samples");
defineArgument(pushRawInterleavedDefinition, "nb_channels", "uint32");
defineArgument(pushRawInterleavedDefinition, "nb_samples", "uint32");
...
defineOutput(getSamplesPDefinition, "RetVal", "uint16", 1);
...
ini_device_structDefinition = addClass(libDef, "libm2k::utils::ini_device_struct", "MATLABName", "clib.libm2k.libm2k.utils.ini_device_struct", ...
    "Description", "clib.libm2k.libm2k.utils.ini_device_struct    Representation of C++ class libm2k::utils::ini_device_struct"); % This description is shown as help to user. Modify it to appropriate description.
...
ini_device_structConstructor1Definition = addConstructor(ini_device_structDefinition, ...
    ...
    "Description", "clib.libm2k.libm2k.utils.ini_device_struct    Constructor of C++ class libm2k::utils::ini_device_struct"); % This description is shown as help to user. Modify it to appropriate description.
...
addProperty(ini_device_structDefinition, "hw_name", "string", ...
    "Description", "string    Data Member of C++ class libm2k::utils::ini_device_struct::hw_name"); % This description is shown as help to user. Modify it to appropriate description.
...
addEnumeration(libDef, "libm2k::utils::DEVICE_TYPE", "int32",...
    ...
    "Description", "clib.libm2k.libm2k.utils.DEVICE_TYPE    Representation of C++ enumeration libm2k::utils::DEVICE_TYPE"); % This description is shown as help to user. Modify it to appropriate description.
...
addEnumeration(libDef, "libm2k::utils::DEVICE_DIRECTION", "int32",...
    ...
    "Description", "clib.libm2k.libm2k.utils.DEVICE_DIRECTION    Representation of C++ enumeration libm2k::utils::DEVICE_DIRECTION"); % This description is shown as help to user. Modify it to appropriate description.
...
UtilsDefinition = addClass(libDef, "libm2k::utils::Utils", "MATLABName", "clib.libm2k.libm2k.utils.Utils", ...
    "Description", "clib.libm2k.libm2k.utils.Utils    Representation of C++ class libm2k::utils::Utils"); % This description is shown as help to user. Modify it to appropriate description.
...
UtilsConstructor1Definition = addConstructor(UtilsDefinition, ...
    ...
    "Description", "clib.libm2k.libm2k.utils.Utils    Constructor of C++ class libm2k::utils::Utils"); % This description is shown as help to user. Modify it to appropriate description.
validate(UtilsConstructor1Definition);

%% C++ class method |getHardwareRevision| for C++ class |libm2k::utils::Utils| 
% C++ Signature: std::string libm2k::utils::Utils::getHardwareRevision(iio_context * ctx)
%getHardwareRevisionDefinition = addMethod(UtilsDefinition, ...
%    "std::string libm2k::utils::Utils::getHardwareRevision(iio_context * ctx)", ...
%    "Description", "clib.libm2k.libm2k.utils.Utils.getHardwareRevision    Method of C++ class libm2k::utils::Utils::getHardwareRevision"); % This description is shown as help to user. Modify it to appropriate description.
...
% C++ Signature: double libm2k::utils::Utils::average(double * data,size_t numElements)
%averageDefinition = addMethod(UtilsDefinition, ...
%    "double libm2k::utils::Utils::average(double * data,size_t numElements)", ...
%    "Description", "clib.libm2k.libm2k.utils.Utils.average    Method of C++ class libm2k::utils::Utils::average"); % This description is shown as help to user. Modify it to appropriate description.
%defineArgument(averageDefinition, "data", "double", <DIRECTION>, <SHAPE>);
...
% C++ Signature: libm2k::utils::DEVICE_DIRECTION libm2k::utils::Utils::getIioDeviceDirection(iio_device * dev)
%getIioDeviceDirectionDefinition = addMethod(UtilsDefinition, ...
%    "libm2k::utils::DEVICE_DIRECTION libm2k::utils::Utils::getIioDeviceDirection(iio_device * dev)", ...
%    "Description", "clib.libm2k.libm2k.utils.Utils.getIioDeviceDirection    Method of C++ class libm2k::utils::Utils::getIioDeviceDirection"); % This description is shown as help to user. Modify it to appropriate description.
...
defineOutput(getAnalogInDefinition, "RetVal", "clib.libm2k.libm2k.analog.GenericAnalogIn", 1);
validate(getAnalogInDefinition);
...
defineOutput(getAnalogOutDefinition, "RetVal", "clib.libm2k.libm2k.analog.GenericAnalogOut", 1);
validate(getAnalogOutDefinition);
